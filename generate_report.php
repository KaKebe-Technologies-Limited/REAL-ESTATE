...
if (!isset($_SESSION['user_id']) || ($_SESSION['user_type'] !== $expected_user_type && $posted_user_type !== $expected_user_type)) {
    ...
    echo '<strong>Warning:</strong> You appear to be logged out or not authorized as an owner. ';
...
// Get owner ID from session (with fallback for debugging)
$owner_id = isset($_SESSION['user_id']) ? $_SESSION['user_id'] : 1; // Default to ID 1 for debugging
...
// If no owner data found (for debugging), create a placeholder
if (!$owner_data) {
    $owner_data = [
        'owner_id' => 1,
        'first_name' => 'Debug',
...
<body>
    <div class="report-container">
        ...
        <div class="report-header">
            ...
            <div class="report-subtitle">Owner: <?php echo $owner_data['first_name'] . ' ' . $owner_data['last_name']; ?></div>
