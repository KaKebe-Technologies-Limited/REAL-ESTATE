...
<body>
                ...
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item dropdown d-none d-lg-block">
                        <a class="nav-link profile-link" href="#" role="button" data-bs-toggle="dropdown">
                            <img src="<?php echo $profile_pic ?? 'uploads/profile_picture/default-profile.jpg'; ?>" alt="Profile" class="rounded-circle profile-picture" onclick="showProfile(); return false;">
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end">
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-profile d-none d-lg-none">
            <a href="#">
                <img src="<?php echo $profile_pic; ?>" alt="Profile" class="profile-picture" onclick="showProfile(); return false;">
            </a>
